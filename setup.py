"""A setuptools based setup module for Metafil.
...
setup(
    ...
    description='A small set of useful tools for filename and metadata generation.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/didamarkovic/metafil',

    # Author details
    author='Dida Markovic',
    author_email='dida.markovic@gmail.com',
